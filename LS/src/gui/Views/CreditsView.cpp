...
namespace gui
{
    CreditsView::CreditsView()
    {
        ...
        l->setPosition(-0.9f, 0.7f-l->getSize().y/2.0f);
        l->setScale(0.5);
        addChild(l);

        l = new gui::Label(font);
        l->addStringComponent(new StringComponentString("Mikael Johnson"));
        l->setPosition(0.1f, 0.7f-l->getSize().y/2.0f);
        l->setScale(0.5);
        addChild(l);
        ...
        l->setPosition(-0.9f, 0.3f-l->getSize().y/2.0f);
        l->setScale(0.5);
        addChild(l);

        l = new gui::Label(font);
        l->addStringComponent(new StringComponentString("Mattias Fredriksson"));
        l->setPosition(0.1f, 0.3f-l->getSize().y/2.0f);
        l->setScale(0.5);
        addChild(l);
